...
func (x *zebraRedistributeIPv4ServiceClient) Recv() (*Route, error) {
	m := new(Route)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *zebraRedistributeIPv6ServiceClient) Recv() (*Route, error) {
	m := new(Route)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *zebraRedistributeIPv4ServiceServer) Send(m *Route) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *zebraRedistributeIPv6ServiceServer) Send(m *Route) error {
	return x.ServerStream.SendMsg(m)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
