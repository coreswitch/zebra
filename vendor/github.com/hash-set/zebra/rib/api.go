...
func InitAPI() {
	...
	Parser.InstallCmd([]string{"routing-options", "static", "route", "A.B.C.D/M", "nexthop", "A.B.C.D"}, IPv4RouteApi)
	Parser.InstallCmd([]string{"routing-options", "static", "route-ipv6", "X:X::X:X/M", "nexthop", "X:X::X:X"}, IPv6RouteApi)
